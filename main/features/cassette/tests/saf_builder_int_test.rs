...
use swe_edge_egress_cassette::{build_cassette_layer, create_config_builder, CassetteConfig, CassetteLayer, Error};
...
fn test_saf_with_config_and_build_produces_cassette_layer() {
    ...
    let layer: CassetteLayer = build_cassette_layer(cfg, "saf_with_config")
