...
use swe_edge_egress_cassette::{build_cassette_layer, CassetteConfig, CassetteLayer, Error};
...
fn test_builder_fn_loads_swe_default_and_succeeds() {
    ...
    build_cassette_layer(cfg, "test_builder_fn_default")
...
fn test_build_record_mode_succeeds() {
    ...
    build_cassette_layer(cfg, "record_mode_test")
...
fn test_build_replay_mode_with_missing_file_succeeds() {
    ...
    build_cassette_layer(cfg, "replay_missing_file")
...
fn test_build_with_empty_scrub_body_paths_succeeds() {
    ...
    build_cassette_layer(cfg, "empty_scrub_paths")
